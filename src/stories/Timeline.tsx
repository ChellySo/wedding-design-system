...
export const Timeline = forwardRef<HTMLDivElement, TimelineProps>(({ className, title, icon, children }, ref) => {
    return (
        <>
            <div className={classNames(className, 'sm:grid hidden grid-cols-[auto_1px_1fr] gap-4 items-start')} ref={ref}>
            ...
            <div className={classNames(className, 'sm:hidden grid grid-cols-[auto_1fr] items-start')} ref={ref}>
