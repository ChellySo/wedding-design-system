    ...
    return (
        color === 'teal' ? (
            <nav className={classNames("text-teal-950 w-full py-8", className)} ref={ref} {...props}>
                ...
                <div className='flex items-center justify-center md:gap-20 sm:gap-14 gap-6'>{children}</div>
            </nav>
        ) : (
            <nav className={classNames("text-rose-white w-full py-8", className)} ref={ref} {...props}>
                ...
                <div className='flex items-center justify-center md:gap-20 sm:gap-14 gap-6'>
                    {children}
                </div>
            </nav>
        )
