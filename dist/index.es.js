...
v2.displayName = "Logo";
const o3 = H(
  ({ children: C, logoShortName: r, className: e, ...t }, s) => /* @__PURE__ */ a.jsxs("footer", { className: z("bg-burgundy-950 w-full py-6 pb-[env(safe-area-inset-bottom)] sm:py-10", e), ref: s, ...t, children: [
