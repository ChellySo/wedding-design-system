  ...
  return _2 || (_2 = 1, process.env.NODE_ENV !== "production" && (function() {
    ...
    function h(n, p, v, y, T, _) {
      ...
      if (o2.call(p, "key")) {
        ...
        y = 0 < V.length ? "{key: someKey, " + V.join(": ..., ") + ": ...}" : "{key: someKey}", d[w + y] || (V = 0 < V.length ? "{" + V.join(": ..., ") + ": ...}" : "{}", console.error(
...
React keys must be passed directly to JSX without using spread:
  ...
  <%s key={someKey} {...props} />`,
    ...
    var S = e3, A = /* @__PURE__ */ Symbol.for("react.transitional.element"), M = /* @__PURE__ */ Symbol.for("react.portal"), R = /* @__PURE__ */ Symbol.for("react.fragment"), Z = /* @__PURE__ */ Symbol.for("react.strict_mode"), K = /* @__PURE__ */ Symbol.for("react.profiler"), q = /* @__PURE__ */ Symbol.for("react.consumer"), W = /* @__PURE__ */ Symbol.for("react.context"), D = /* @__PURE__ */ Symbol.for("react.forward_ref"), G = /* @__PURE__ */ Symbol.for("react.suspense"), J = /* @__PURE__ */ Symbol.for("react.suspense_list"), c = /* @__PURE__ */ Symbol.for("react.memo"), z = /* @__PURE__ */ Symbol.for("react.lazy"), i2 = /* @__PURE__ */ Symbol.for("react.activity"), C2 = /* @__PURE__ */ Symbol.for("react.client.reference"), Y = S.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, o2 = Object.prototype.hasOwnProperty, n2 = Array.isArray, I = console.createTask ? console.createTask : function() {
      return null;
    };
    S = {
...
var E2;
function o3() {
  return E2 || (E2 = 1, process.env.NODE_ENV === "production" ? f2.exports = r3() : f2.exports = t3()), f2.exports;
}
var u = o3();
function Z2(e) {
  var o, r, t = "";
...
const M2 = (e) => typeof e == "boolean" ? `${e}` : e === 0 ? "0" : e, z2 = G2, k2 = (e, o) => (r) => {
...
}, i3 = (e) => e.slice(1, -1).indexOf(":") === -1 ? void 0 : (() => {
  const o = e.slice(1, -1), r = o.indexOf(":"), t = o.slice(0, r);
  return t ? a3 + t : void 0;
})(), C3 = (e) => {
  const {
    theme: o,
    classGroups: r
  ...
  o.validators === null && (o.validators = []), o.validators.push(s3(r, e));
}, f3 = (e, o, r, t) => {
  ...
  return r;
}, b3 = (e) => "isThemeGetter" in e && e.isThemeGetter === !0, p3 = (e) => {
  if (e < 1)
    return {
      get: () => {
      },
  ...
  if (o) {
    const s = o + A2, a = t;
    t = (l) => l.startsWith(s) ? a(l.slice(s.length)) : N2(g3, !1, l, void 0, !0);
  }
  if (r) {
    const s = t;
    t = (a) => r({
  ...
  for (let b = f.length - 1; b >= 0; b -= 1) {
    ...
    const K = k.length === 0 ? "" : k.length === 1 ? k[0] : a(k).join(":"), q = S ? K + v2 : K, W = q + Z;
    if (l.indexOf(W) > -1)
      continue;
    l.push(W);
    const D = s(Z, R);
  ...
  const l = (m) => {
    ...
    return r = v3(b), t = r.cache.get, s = r.cache.set, a = f, f(m);
  }, f = (m) => {
    const b = t(m);
    if (b)
      return b;
...
}, Y2 = /^\[(?:(\w[\w-]*):)?(.+)\]$/i, B2 = /^\((?:(\w[\w-]*):)?(.+)\)$/i, T3 = /^\d+(?:\.\d+)?\/\d+(?:\.\d+)?$/, _3 = /^(\d+(\.\d+)?)?(xs|sm|md|lg|xl)$/, E3 = /\d+(%|px|r?em|[sdl]?v([hwib]|min|max)|pt|pc|in|cm|mm|cap|ch|ex|r?lh|cq(w|h|i|b|min|max))|\b(calc|min|max|clamp)\(.+\)|^0$/, M3 = /^(rgba?|hsla?|hwb|(ok)?(lab|lch)|color-mix)\(.+\)$/, z3 = /^(inset_)?-?((\d+)?\.?(\d+)[a-z]+|0)_-?((\d+)?\.?(\d+)[a-z]+|0)/, S3 = /^(url|image|image-set|cross-fade|element|(repeating-)?(linear|radial|conic)-gradient)\(.+\)$/, B = (e) => T3.test(e), g = (e) => !!e && !Number.isNaN(Number(e)), $ = (e) => !!e && Number.isInteger(Number(e)), x2 = (e) => e.endsWith("%") && g(e.slice(0, -1)), F = (e) => _3.test(e), $2 = () => !0, A3 = (e) => (
  // `colorFunctionRegex` check is necessary because color functions can have percentages in them which which would be incorrectly classified as lengths.
  // For example, `hsl(0 0% 0%)` would be classified as a length without this check.
  // I could also use lookbehind assertion in `lengthUnitRegex` but that isn't supported widely enough.
  E3.test(e) && !M3.test(e)
), R2 = () => !1, N3 = (e) => z3.test(e), P3 = (e) => S3.test(e), O3 = (e) => !i(e) && !C(e), I3 = (e) => H(e, q2, R2), i = (e) => Y2.test(e), X = (e) => H(e, J2, A3), P2 = (e) => H(e, Y3, g), L3 = (e) => H(e, Q2, $2), Z3 = (e) => H(e, X2, R2), O2 = (e) => H(e, U2, R2), G3 = (e) => H(e, H2, P3), b2 = (e) => H(e, K2, N3), C = (e) => B2.test(e), l2 = (e) => Q(e, J2), V3 = (e) => Q(e, X2), I2 = (e) => Q(e, U2), F3 = (e) => Q(e, q2), W3 = (e) => Q(e, H2), p2 = (e) => Q(e, K2, !0), D3 = (e) => Q(e, Q2, !0), H = (e, o, r) => {
  const t = Y2.exec(e);
  return t ? t[1] ? o(t[1]) : r(t[2]) : !1;
}, Q = (e, o, r = !1) => {
  const t = B2.exec(e);
  return t ? t[1] ? o(t[1]) : r : !1;
}, U2 = (e) => e === "position" || e === "percentage", H2 = (e) => e === "image" || e === "url", q2 = (e) => e === "length" || e === "size" || e === "bg-size", J2 = (e) => e === "length", Y3 = (e) => e === "number", X2 = (e) => e === "family-name", Q2 = (e) => e === "number" || e === "weight", K2 = (e) => e === "shadow", B3 = () => {
  const e = E("color"), o = E("font"), r = E("text"), t = E("font-weight"), s = E("tracking"), a = E("leading"), l = E("breakpoint"), f = E("container"), m = E("spacing"), b = E("radius"), h = E("shadow"), x = E("inset-shadow"), k = E("text-shadow"), S = E("drop-shadow"), A = E("blur"), M = E("perspective"), R = E("aspect"), Z = E("ease"), K = E("animate"), q = () => ["auto", "avoid", "all", "avoid-page", "page", "left", "right", "column"], W = () => [
    "center",
    "top",
    "bottom",
    "left",
    ...
    // Deprecated since Tailwind CSS v4.1.0, see https://github.com/tailwindlabs/tailwindcss/pull/17378
    "left-bottom"
  ], D = () => [...W(), C, i], G = () => ["auto", "hidden", "clip", "visible", "scroll"], J = () => ["auto", "contain", "none"], c = () => [C, i, m], z = () => [B, "full", "auto", ...c()], i2 = () => [$, "none", "subgrid", C, i], C2 = () => ["auto", {
    span: ["full", $, C, i]
  }, $, C, i], Y = () => [$, "auto", C, i], o2 = () => ["auto", "min", "max", "fr", C, i], n2 = () => ["start", "end", "center", "between", "around", "evenly", "stretch", "baseline", "center-safe", "end-safe"], I = () => ["start", "end", "center", "stretch", "center-safe", "end-safe"], N = () => ["auto", ...c()], L = () => [B, "auto", "full", "dvw", "dvh", "lvw", "lvh", "svw", "svh", "min", "max", "fit", ...c()], e2 = () => [B, "screen", "full", "dvw", "lvw", "svw", "min", "max", "fit", ...c()], r2 = () => [B, "screen", "full", "lh", "dvh", "lvh", "svh", "min", "max", "fit", ...c()], d = () => [e, C, i], n = () => [...W(), I2, O2, {
    position: [C, i]
  }], p = () => ["no-repeat", {
    repeat: ["", "x", "y", "space", "round"]
  }], v = () => ["auto", "cover", "contain", F3, I3, {
    size: [C, i]
  }], y = () => [x2, l2, X], T = () => [
    ...
    C,
    i
  ], _ = () => ["", g, l2, X], w = () => ["solid", "dashed", "dotted", "double"], V = () => ["normal", "multiply", "screen", "overlay", "darken", "lighten", "color-dodge", "color-burn", "hard-light", "soft-light", "difference", "exclusion", "hue", "saturation", "color", "luminosity"], j = () => [g, x2, I2, O2], c2 = () => [
    // Deprecated since Tailwind CSS v4.0.0
    "",
    "none",
    A,
...
const U3 = "flex space-x-xs items-center justify-center duration-150 outline-none ring-offset-transparent focus-visible:outline-none", t2 = {
  ...
  ({ variant: e, size: o, fullWidth: r, disabled: t, className: s, children: a, ...l }, f) => /* @__PURE__ */ u.jsx(
    "button",
    {
      disabled: t,
      ref: f,
      className: O(O, H3({ fullWidth: r, disabled: t, variant: e, size: o }), s),
      ...l,
      children: a
    }
  )
...
const X3 = ({ ...e }) => /* @__PURE__ */ u.jsx("svg", { xmlns: "http://www.w3.org/2000/svg", fill: "#58131B", version: "1.1", id: "Capa_1", width: "800px", height: "800px", viewBox: "0 0 378.94 378.94", ...e, children: /* @__PURE__ */ u.jsx("g", { children: /* @__PURE__ */ u.jsx("path", { d: "M348.151,54.514c-19.883-19.884-46.315-30.826-74.435-30.826c-28.124,0-54.559,10.942-74.449,30.826l-9.798,9.8l-9.798-9.8   c-19.884-19.884-46.325-30.826-74.443-30.826c-28.117,0-54.56,10.942-74.442,30.826c-41.049,41.053-41.049,107.848,0,148.885   l147.09,147.091c2.405,2.414,5.399,3.892,8.527,4.461c1.049,0.207,2.104,0.303,3.161,0.303c4.161,0,8.329-1.587,11.498-4.764   l147.09-147.091C389.203,162.362,389.203,95.567,348.151,54.514z M325.155,180.404L189.47,316.091L53.782,180.404   c-28.368-28.364-28.368-74.514,0-102.893c13.741-13.739,32.017-21.296,51.446-21.296c19.431,0,37.702,7.557,51.438,21.296   l21.305,21.312c6.107,6.098,16.897,6.098,23.003,0l21.297-21.312c13.737-13.739,32.009-21.296,51.446-21.296   c19.431,0,37.701,7.557,51.438,21.296C353.526,105.89,353.526,152.039,325.155,180.404z" }) }) }), Q3 = k2("font-medium", {
  ...
  ({ as: e = "p", variant: o, size: r, className: t, children: s, ...a }, l) => /* @__PURE__ */ u.jsx(
    ...
    {
      ref: l,
      className: O(t, Q3({ variant: o, size: r, className: t })),
      ...a,
      children: s
    }
  )
...
K3.displayName = "Timeline";
const e4 = U.forwardRef(
  ({ color: e, children: o, className: r, ...t }, s) => e === "teal" ? /* @__PURE__ */ u.jsxs("nav", { className: O("text-teal-950 w-full py-8", r), ref: s, ...t, children: [
    /* @__PURE__ */ u.jsx(L2, { href: "/", className: "block w-fit mx-auto mb-8", children: /* @__PURE__ */ u.jsx(y2, { color: "teal" }) }),
    ...
    /* @__PURE__ */ u.jsx(L2, { href: "/", className: "block w-fit mx-auto mb-8", children: /* @__PURE__ */ u.jsx(y2, { color: "white" }) }),
    /* @__PURE__ */ u.jsx("div", { className: "grid grid-flow-col auto-cols-max gap-16 justify-center text-center", children: o })
  ] })
);
e4.displayName = "NavBar";
const r4 = U.forwardRef(
