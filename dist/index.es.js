import r3, { forwardRef as X, useState as t3, useEffect as o3 } from "react";
var f2 = { exports: {} }, n2 = {};
var T2;
function s3() {
  if (T2) return n2;
  ...
  return n2.Fragment = o, n2.jsx = r, n2.jsxs = r, n2;
}
var a2 = {};
var z2;
function n3() {
...
function Z2(e) {
  ...
  if (typeof e == "string" || typeof e == "number") t += e;
    ...
    var n = e.length;
    for (o = 0; o < n; o++) e[o] && (r = Z2(e[o])) && (t && (t += " "), t += r);
...
const M2 = (e) => typeof e == "boolean" ? `${e}` : e === 0 ? "0" : e, N2 = G2, j2 = (e, o) => (r) => {
  ...
  const n = e[o], a = r.nextPart.get(n);
  if (a) {
    const b = F2(e, o + 1, a);
    if (b) return b;
  }
  ...
  o.validators === null && (o.validators = []), o.validators.push(C3(r, e));
}, h3 = (e, o, r, t) => {
  ...
  return r;
}, x3 = (e) => "isThemeGetter" in e && e.isThemeGetter === !0, v3 = (e) => {
  if (e < 1)
    return {
      get: () => {
      },
  ...
  return e.orderSensitiveModifiers.forEach((r, t) => {
    ...
    for (let a = 0; a < r.length; a++) {
      ...
      f || m ? (n.length > 0 && (n.sort(), t.push(...n), n = []), t.push(l)) : n.push(l);
    }
  ...
  for (let b = f.length - 1; b >= 0; b -= 1) {
    ...
    let R = !!_, Z = t(R ? A.substring(0, _) : A);
    if (!Z) {
      if (!R) {
        m = h + (m.length > 0 ? " " + m : m);
        continue;
  ...
  const l = (m) => {
    ...
    return r = j3(b), t = r.cache.get, n = r.cache.set, a = f, f(m);
  }, f = (m) => {
    const b = t(m);
    if (b)
      return b;
  ...
  const e = z("color"), o = z("font"), r = z("text"), t = z("font-weight"), n = z("tracking"), a = z("leading"), l = z("breakpoint"), f = z("container"), m = z("spacing"), b = z("radius"), h = z("shadow"), x = z("inset-shadow"), k = z("text-shadow"), N = z("drop-shadow"), A = z("blur"), _ = z("perspective"), R = z("aspect"), Z = z("ease"), K = z("animate"), H = () => ["auto", "avoid", "all", "avoid-page", "page", "left", "right", "column"], W = () => [
    ...
    C,
    i
  ], d2 = () => ["none", g, C, i], u2 = () => ["none", g, C, i], x2 = () => [g, C, i], m2 = () => [$, "full", ...d()];
  return {
    cacheSize: 500,
    theme: {
...
const X3 = "flex space-x-xs items-center justify-center duration-150 outline-none ring-offset-transparent focus-visible:outline-none", t2 = {
  ...
  variants: {
    variant: {
      primary: O(t2.default, t2.primary),
      secondary: O(t2.default, t2.secondary),
      tertiary: O(t2.default, t2.tertiary)
    },
    size: {
      sm: "text-sm",
      md: "text-md",
  ...
  ({ variant: e, size: o, fullWidth: r, disabled: t, className: n, children: a, ...l }, f) => /* @__PURE__ */ c.jsx(
    "button",
    {
      disabled: t,
      ref: f,
      className: O(O, Q3({ fullWidth: r, disabled: t, variant: e, size: o }), n),
      ...l,
      children: a
    }
  )
...
const K3 = j2("font-bold", {
  ...
  ({ as: e = "h1", color: o, size: r, className: t, children: n, ...a }, l) => /* @__PURE__ */ c.jsx(
    e,
    {
      ref: l,
      className: O(t, K3({ color: o, size: r, className: t })),
      ...a,
      children: n
    }
  )
...
const r4 = j2("font-medium", {
  ...
  ({ as: e = "p", variant: o, size: r, className: t, children: n, ...a }, l) => /* @__PURE__ */ c.jsx(
    e,
    {
      ref: l,
      className: O(t, r4({ variant: o, size: r, className: t })),
      ...a,
      children: n
    }
  )
...
const s4 = X(
  ({ className: e, title: o, text: r, heartIcon: t, icon: n }, a) => /* @__PURE__ */ c.jsx(c.Fragment, { children: t ? /* @__PURE__ */ c.jsxs("div", { className: O(e, "grid grid-cols-[auto_1px_1fr] gap-4 items-start"), ref: a, children: [
    ...
    /* @__PURE__ */ c.jsxs("div", { className: "mb-12 mx-4", children: [
      /* @__PURE__ */ c.jsx(h2, { color: "teal", size: "h3", children: o }),
      /* @__PURE__ */ c.jsx(P, { variant: "teal", size: "md", children: r })
    ] })
