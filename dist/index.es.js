...
const h2 = ({ href: C, children: r, className: e, as: t = "a", ...s }) => /* @__PURE__ */ a.jsx(t, { href: C, className: e, ...s, children: r }), C3 = H(({ className: C, imageSrc: r, title: e, children: t, size: s, buttonText: n, hrefButtonLink: l, disableButton: f }, d) => /* @__PURE__ */ a.jsxs("div", { className: z(C, `${s === "sm" ? "max-w-sm" : "max-w-2xl"}`, "w-full bg-white shadow-md rounded-sm flex flex-col h-full"), ref: d, children: [
  ...
  /* @__PURE__ */ a.jsxs("div", { className: "p-4 text-center items-center flex flex-col flex-1", children: [
    ...
    n && /* @__PURE__ */ a.jsx("div", { className: "mt-auto pt-4 flex justify-center", children: /* @__PURE__ */ a.jsx(C1, { variant: "primary", size: "lg", disabled: f, children: /* @__PURE__ */ a.jsx(h2, { href: l || "/", children: n }) }) })
  ] })
] }));
C3.displayName = "Card";
...
const o3 = H(
  ({ children: C, logoShortName: r, className: e, ...t }, s) => /* @__PURE__ */ a.jsxs("footer", { className: z("bg-[linear-gradient(to_bottom,#58131B_11%,#FCFBFB_95%,#FCFBFB_100%)] w-full pt-6 pb-10 sm:pb-20 sm:pt-12", e), ref: s, ...t, children: [
    ...
    /* @__PURE__ */ a.jsx("div", { className: "grid grid-flow-col auto-cols-max md:gap-20 sm:gap-14 gap-6 justify-center text-center mt-12 mb-6", children: C })
  ] })
);
