...
v2.displayName = "Logo";
const o3 = H(
  ({ children: C, logoShortName: r, className: e, ...t }, s) => /* @__PURE__ */ a.jsxs("footer", { className: z("bg-burgundy-950 w-full p-10", e), ref: s, ...t, children: [
...
const l3 = ({ href: C, children: r, className: e, ...t }) => /* @__PURE__ */ a.jsx("a", { href: C, className: e, target: "_blank", rel: "noopener noreferrer", ...t, children: r }), s3 = H(
  ({ color: C, children: r, className: e, logoShortName: t, ...s }, n) => C === "teal" ? /* @__PURE__ */ a.jsxs("nav", { className: z("text-teal-950 w-full py-8", e), ref: n, ...s, children: [
  ...
  ] }) : /* @__PURE__ */ a.jsxs("nav", { className: z("text-rose-white w-full py-8", e), ref: n, ...s, children: [
