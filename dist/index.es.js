...
React keys must be passed directly to JSX without using spread:
  ...
  <%s key={someKey} {...props} />`,
    ...
    function j(o) {
      h(o) ? o._store && (o._store.validated = 1) : typeof o == "object" && o !== null && o.$$typeof === T && (o._payload.status === "fulfilled" ? h(o._payload.value) && o._payload.value._store && (o._payload.value._store.validated = 1) : o._store && (o._store.validated = 1));
    }
    function h(o) {
      return typeof o == "object" && o !== null && o.$$typeof === A;
    }
    var E = e1, A = /* @__PURE__ */ Symbol.for("react.transitional.element"), _ = /* @__PURE__ */ Symbol.for("react.portal"), y = /* @__PURE__ */ Symbol.for("react.fragment"), I = /* @__PURE__ */ Symbol.for("react.strict_mode"), K = /* @__PURE__ */ Symbol.for("react.profiler"), q = /* @__PURE__ */ Symbol.for("react.consumer"), B = /* @__PURE__ */ Symbol.for("react.context"), D = /* @__PURE__ */ Symbol.for("react.forward_ref"), F = /* @__PURE__ */ Symbol.for("react.suspense"), J = /* @__PURE__ */ Symbol.for("react.suspense_list"), m = /* @__PURE__ */ Symbol.for("react.memo"), T = /* @__PURE__ */ Symbol.for("react.lazy"), l2 = /* @__PURE__ */ Symbol.for("react.activity"), i2 = /* @__PURE__ */ Symbol.for("react.client.reference"), W = E.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, r2 = Object.prototype.hasOwnProperty, o2 = Array.isArray, O = console.createTask ? console.createTask : function() {
      return null;
    };
    E = {
    ...
    var S, L = {}, C2 = E.react_stack_bottom_frame.bind(
      E,
      n
    )(), e2 = O(t(n)), u = {};
...
var _2;
function n1() {
  return _2 || (_2 = 1, process.env.NODE_ENV === "production" ? f2.exports = o1() : f2.exports = s1()), f2.exports;
}
var a = n1();
...
const T2 = (C) => typeof C == "boolean" ? `${C}` : C === 0 ? "0" : C, E2 = F2, M2 = (C, r) => (e) => {
  var t;
  if (r?.variants == null) return E2(C, e?.class, e?.className);
  ...
  return E2(C, l, d, e?.class, e?.className);
}, l1 = (C, r) => {
  ...
  let t = (s) => {
    ...
    let h = j, E = !1;
    j.endsWith(k2) ? (h = j.slice(0, -1), E = !0) : (
      /**
       * In Tailwind CSS v3 the important modifier was at the start of the base class name. This is still supported for legacy reasons.
       * @see https://github.com/dcastil/tailwind-merge/issues/513#issuecomment-2614029864
       */
      j.startsWith(k2) && (h = j.slice(1), E = !0)
    );
  ...
  for (let x = f.length - 1; x >= 0; x -= 1) {
    ...
    let y = !!_, I = t(y ? A.substring(0, _) : A);
    if (!I) {
      if (!y) {
        d = g + (d.length > 0 ? " " + d : d);
        continue;
    ...
    const K = h.length === 0 ? "" : h.length === 1 ? h[0] : n(h).join(":"), q = E ? K + k2 : K, B = q + I;
    if (l.indexOf(B) > -1)
      continue;
    l.push(B);
    const D = s(I, y);
...
}, W2 = /^\[(?:(\w[\w-]*):)?(.+)\]$/i, Y2 = /^\((?:(\w[\w-]*):)?(.+)\)$/i, T1 = /^\d+(?:\.\d+)?\/\d+(?:\.\d+)?$/, E1 = /^(\d+(\.\d+)?)?(xs|sm|md|lg|xl)$/, A1 = /\d+(%|px|r?em|[sdl]?v([hwib]|min|max)|pt|pc|in|cm|mm|cap|ch|ex|r?lh|cq(w|h|i|b|min|max))|\b(calc|min|max|clamp)\(.+\)|^0$/, S1 = /^(rgba?|hsla?|hwb|(ok)?(lab|lch)|color-mix)\(.+\)$/, z1 = /^(inset_)?-?((\d+)?\.?(\d+)[a-z]+|0)_-?((\d+)?\.?(\d+)[a-z]+|0)/, P1 = /^(url|image|image-set|cross-fade|element|(repeating-)?(linear|radial|conic)-gradient)\(.+\)$/, Y = (C) => T1.test(C), p = (C) => !!C && !Number.isNaN(Number(C)), $ = (C) => !!C && Number.isInteger(Number(C)), y2 = (C) => C.endsWith("%") && p(C.slice(0, -1)), G = (C) => E1.test(C), $2 = () => !0, O1 = (C) => (
  // `colorFunctionRegex` check is necessary because color functions can have percentages in them which which would be incorrectly classified as lengths.
  // For example, `hsl(0 0% 0%)` would be classified as a length without this check.
  // I could also use lookbehind assertion in `lengthUnitRegex` but that isn't supported widely enough.
  A1.test(C) && !S1.test(C)
), N2 = () => !1, L1 = (C) => z1.test(C), I1 = (C) => P1.test(C), F1 = (C) => !i(C) && !c(C), V1 = (C) => U(C, q2, N2), i = (C) => W2.test(C), X = (C) => U(C, J2, O1), P2 = (C) => U(C, U1, p), G1 = (C) => U(C, Q2, $2), B1 = (C) => U(C, X2, N2), O2 = (C) => U(C, H2, N2), D1 = (C) => U(C, U2, I1), x2 = (C) => U(C, K2, L1), c = (C) => Y2.test(C), a2 = (C) => Q(C, J2), W1 = (C) => Q(C, X2), L2 = (C) => Q(C, H2), Y1 = (C) => Q(C, q2), $1 = (C) => Q(C, U2), b2 = (C) => Q(C, K2, !0), H1 = (C) => Q(C, Q2, !0), U = (C, r, e) => {
  const t = W2.exec(C);
  ...
  const C = R("color"), r = R("font"), e = R("text"), t = R("font-weight"), s = R("tracking"), n = R("leading"), l = R("breakpoint"), f = R("container"), d = R("spacing"), x = R("radius"), g = R("shadow"), j = R("inset-shadow"), h = R("text-shadow"), E = R("drop-shadow"), A = R("blur"), _ = R("perspective"), y = R("aspect"), I = R("ease"), K = R("animate"), q = () => ["auto", "avoid", "all", "avoid-page", "page", "left", "right", "column"], B = () => [
    "center",
    "top",
    "bottom",
    "left",
    ...
    // Deprecated since Tailwind CSS v4.1.0, see https://github.com/tailwindlabs/tailwindcss/pull/17378
    "left-bottom"
  ], D = () => [...B(), c, i], F = () => ["auto", "hidden", "clip", "visible", "scroll"], J = () => ["auto", "contain", "none"], m = () => [c, i, d], T = () => [Y, "full", "auto", ...m()], l2 = () => [$, "none", "subgrid", c, i], i2 = () => ["auto", {
    span: ["full", $, c, i]
  }, $, c, i], W = () => [$, "auto", c, i], r2 = () => ["auto", "min", "max", "fr", c, i], o2 = () => ["start", "end", "center", "between", "around", "evenly", "stretch", "baseline", "center-safe", "end-safe"], O = () => ["start", "end", "center", "stretch", "center-safe", "end-safe"], S = () => ["auto", ...m()], L = () => [Y, "auto", "full", "dvw", "dvh", "lvw", "lvh", "svw", "svh", "min", "max", "fit", ...m()], C2 = () => [Y, "screen", "full", "dvw", "lvw", "svw", "min", "max", "fit", ...m()], e2 = () => [Y, "screen", "full", "lh", "dvh", "lvh", "svh", "min", "max", "fit", ...m()], u = () => [C, c, i], o = () => [...B(), L2, O2, {
    position: [c, i]
  }], b = () => ["no-repeat", {
...
const h2 = ({ href: C, children: r, className: e, as: t = "a", ...s }) => /* @__PURE__ */ a.jsx(t, { href: C, className: e, ...s, children: r }), C3 = ({ href: C, children: r, className: e, ...t }) => /* @__PURE__ */ a.jsx("a", { href: C, className: e, target: "_blank", rel: "noopener noreferrer", ...t, children: r }), e3 = H(({ className: C, imageSrc: r, title: e, children: t, size: s, buttonText: n, hrefButtonLink: l, disableButton: f, ExternalLink: d }, x) => /* @__PURE__ */ a.jsxs("div", { className: z(C, `${s === "sm" ? "max-w-sm" : "max-w-2xl"}`, "w-full bg-white shadow-md rounded-sm flex flex-col h-full"), ref: x, children: [
  ...
  /* @__PURE__ */ a.jsxs("div", { className: "p-4 text-center items-center flex flex-col flex-1", children: [
    ...
    /* @__PURE__ */ a.jsx("div", { className: "flex-1 my-4 w-full", children: t }),
    n && /* @__PURE__ */ a.jsx("div", { className: "mt-auto pt-4 flex justify-center", children: /* @__PURE__ */ a.jsx(C1, { variant: "primary", size: "lg", disabled: f, children: d ? /* @__PURE__ */ a.jsx(C3, { href: l || "/", children: n }) : /* @__PURE__ */ a.jsx(h2, { href: l || "/", children: n }) }) })
  ] })
] }));
e3.displayName = "Card";
const t3 = M2("font-normal", {
  variants: {
    variant: {
      burgundy: "text-burgundy-950",
      teal: "text-teal-950",
  ...
  ({ as: C = "p", variant: r, size: e, className: t, children: s, ...n }, l) => /* @__PURE__ */ a.jsx(
    ...
    {
      ref: l,
      className: z(t3({ variant: r, size: e }), t),
      ...n,
      children: s
    }
  )
...
const r3 = H(
  ({ weddingDate: C, className: r, ...e }, t) => {
    const s = () => {
      const d = /* @__PURE__ */ new Date(), x = new Date(C), g = d.getTime(), h = x.getTime() - g, E = Math.floor(h / (1e3 * 60 * 60 * 24)), A = Math.floor(h % (1e3 * 60 * 60 * 24) / (1e3 * 60 * 60)), _ = Math.floor(h % (1e3 * 60 * 60) / (1e3 * 60)), y = Math.floor(h % (1e3 * 60) / 1e3);
      return { days: E, hours: A, minutes: _, seconds: y };
    }, [n, l] = t1(s());
    r1(() => {
      const d = setInterval(() => {
        l(s());
